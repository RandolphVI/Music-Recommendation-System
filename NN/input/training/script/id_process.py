...
for column in columns:
    ...
    column_encoder.fit((train[column].append(test[column])).astype(str))
...
for column in columns:
    column_encoder = LabelEncoder()
    column_encoder.fit(members[column].astype(str))
    members[column] = column_encoder.transform(members[column].astype(str))
...
for column in columns:
    column_encoder = LabelEncoder()
    column_encoder.fit(songs[column].astype(str))
    songs[column] = column_encoder.transform(songs[column].astype(str))
